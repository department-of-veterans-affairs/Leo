...
public class Token_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("gov.va.vinci.leo.types.Token");
  ...
  public int getTokenType(int addr) {
      ...
      jcas.throwFeatMissing("TokenType", "gov.va.vinci.leo.types.Token");
