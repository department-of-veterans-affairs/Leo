 ...
 * @generated */
public class AuHearts extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(AuHearts.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected AuHearts() {/* intentionally empty block */}
   ...
   */
  public AuHearts(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public AuHearts(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
